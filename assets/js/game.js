...
function verificar1(){
    let resposta1 = document.getElementById("correta1").checked
    if (resposta1 == true) 
    {
...
function verificar2(){
    let resposta2 = document.getElementById("correta2").checked
    if (resposta2 == true) 
    {
...
function verificar3(){
    let resposta3 = document.getElementById("correta3").checked
    if (resposta3 == true) 
    {
...
function verificar4(){
    let resposta4= document.getElementById("correta4").checked
    if (resposta4 == true) 
    {
...
function verificar5(){
    let resposta5= document.getElementById("correta5").checked
    if (resposta5 == true) 
    {
...
function verificar6(){
    let resposta6= document.getElementById("correta6").checked
    if (resposta6 == true) 
    {
...
function verificar7(){
    let resposta7= document.getElementById("correta7").checked
    if (resposta7 == true) 
    {
...
function verificar8(){
    let resposta8 = document.getElementById("correta8").checked
    if (resposta8 == true) 
    {
...
function verificar9(){
    let resposta9 = document.getElementById("correta9").checked
    if (resposta9 == true) 
    {
...
function verificar10(){
    let resposta10 = document.getElementById("correta10").checked
    if (resposta10 == true) 
    {
...
function verificar11(){
    let resposta11 = document.getElementById("correta11").checked
    if (resposta11 == true) 
    {
...
function verificar12(){
    let resposta12 = document.getElementById("correta12").checked
    if (resposta12 == true) 
    {
